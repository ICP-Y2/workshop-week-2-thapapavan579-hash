...
Ans: we observed that when four 1.5V of battery is connected in series connection, the multimeter showed overall volatage of 6V.
Here, when the batteries are connected in series, the overall voltage across the circuit is the sum of the voltage of the batteries.
...
c.	R2: _________2_______ V: _______1mv______    Measured Voltage: _______666mv________
